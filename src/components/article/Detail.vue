            ...
            <div class="col-md-12 col-lg-8 main-content">
              <div class="post-meta">
                <span class="author mr-2">
                  <img src="/assets/images/person_1.jpg" :alt="article.added_by" class="mr-2" />
                  {{ article.added_by }}
                </span>
                &bullet;
              ...
              <div class="pt-5">
                <p>
                  Categories:
                  <router-link v-for="(category, id) in article.categories" :key="id" :to="{
                      name: 'categoryDetail',
                      ...
                      <div class="col-md-12 form-group">
                        ...
                        <ValidationProvider name="mobile" rules="required|numeric" v-slot="{ errors }" :bails="false">
                          <div class="input-group">
                            ...
                            <button class="btn btn-warning btn-sm input-group-btn" @click="verify" type="button">Send
                              code</button>
                          </div>
                        </ValidationProvider>
                    ...
                    <div class="row">
                      <ValidationProvider name="comment" rules="required" v-slot="{ errors }">
                        <div class="col-md-12 form-group">
                          ...
                          <textarea name="comment" id="comment" class="form-control" cols="100" rows="5"
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6 col-lg-4" v-for="(related, index) in related_articles" :key="index">
              <router-link class="a-block sm d-flex align-items-center height-md"
                :style="{ 'background-image': 'url(' + related.image + ')' }" v-bind:to="{
                  name: 'articleDetail',
